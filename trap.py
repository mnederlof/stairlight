...
def up_to_down():
  ...
  p1 = Process(target=fade, args=(tree1w, 'on', valw))
  p2 = Process(target=fade, args=(tree2w, 'on', valw))
  p3 = Process(target=fade, args=(tree3w, 'on', valw))
  p4 = Process(target=fade, args=(tree4w, 'on', valw))
  p5 = Process(target=fade, args=(tree5w, 'on', valw))
  p6 = Process(target=fade, args=(tree6w, 'on', valw))
  p7 = Process(target=fade, args=(tree7w, 'on', valw))
  p8 = Process(target=fade, args=(tree8w, 'on', valw))
  p9 = Process(target=fade, args=(tree9w, 'on', valw))
  p10 = Process(target=fade, args=(tree10w, 'on', valw))
  p11 = Process(target=fade, args=(tree11w, 'on', valw))
  p12 = Process(target=fade, args=(tree12w, 'on', valw))
  p13 = Process(target=fade, args=(tree13w, 'on', valw))
  p13.start()
  time.sleep(ndel)
  p12.start()
  time.sleep(ndel)
